...
//This code implements specific DTDL or Device Model, in this case Thermostat.json or dtmi:com:example:Thermostat;1
//Every device type to be simulated will need DTDL and associated class to implement the model as below
